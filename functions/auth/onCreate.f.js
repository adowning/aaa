...
exports = module.exports = functions.auth.user().onCreate( event => {
  ...
  if(email){
    const mailOptions = {
      from: '"Ash Downing <ash@andrewscarpetcleaning.com>',
      to: email,
      subject: `Welcome to Andrews Admin`,
      text: `Hey ${displayName}!, App is in heavy development, please let me know if you have issues.`
    }
